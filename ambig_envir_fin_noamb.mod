...
%log(fg) = rho_fg*log(fg(-1)) - (ag) + sh_fg;
%log(fg) = rho_fg*log(fg(-1)) + sh_fg;
%log(fd) = rho_fd*log(fd(-1))  + sh_fd;
fg = 0.35 + sh_fg;
fd = 0.35 + sh_fd;
...
mat_sh_amb2 = [yd_sh_amb2 yg_sh_amb2 pd_sh_amb2 pg_sh_amb2 kg_sh_amb2 wg_sh_amb2 hg_sh_amb2 kd_sh_amb2 wd_sh_amb2 ... 
              ...
              m_sh_amb2 e_sh_amb2 h_sh_amb2 ag_sh_amb2 amb_sh_amb ad_sh_amb2 amb_sh_amb qd_sh_amb2 qg_sh_amb2 ...

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [ys,params,check]=ambig_envir_fin_mm_steadystate(ys,exe,M_,options_)
% compute s.s.
%global M_ options_
check = 0;
...
chi = 0.4221; %damage 2100 5% output loss

params = [params amb ad ag r fd fg zd zg qd qg chi];
...
X0 = [yd0 yg0 pd0 pg0 kg0 wg0 hg0 kd0 wd0 hd0 e0 y0 lambda0 c0 invd0 invg0 m0 l0 lg0 ld0 b0];

...
var yd yg pd pg kg wg hg kd wd hd y lambda c invd invg r qd qg m e h ag amb zamb ad fin
    welf taud taug fd fg zd zg ezd ezg lg ld l b disc spreadd spreadg diffz kappa_flu;

varexo sh_ag sh_amb sh_ad sh_fg sh_fd sh_fin;

parameters rho_y nu alpha sigma_h delta beta phi betad betag betab kappa weightd weightg mg md
           gammap gammad gammag gammab epsilon gamma_i delta_m m_bar xi
...
l = ld+lg;
b = (1-kappa_flu*weightd)*ld + (1-kappa_flu*weightg)*lg;
betab*disc*(zg*(1-fg(+1))) = kappa_flu*weightg + (1-kappa_flu*weightg)*betab*r*disc;
betab*disc*(zd*(1-fd(+1)))= kappa_flu*weightd + (1-kappa_flu*weightd)*betab*r*disc;
h=hg+hd;
y=c+invg+invd;
...
spreadg=zg/r;
diffz=zg/zd;
kappa_flu = kappa*(y/steady_state(y))^(-0);
end;
...
welf_ss_loss = (((steady_state_welfare) - (steady_state_welfare_base))/abs(steady_state_welfare_base))
adj = ((steady_state_welfare_base) - (steady_state_welfare));
mean_welfare_adj = mean_welfare + adj;

welf_mean_loss = (((mean_welfare) - (mean_welfare_base))/abs(mean_welfare_base))
welf_mean_loss_adj = (((mean_welfare_adj) - (mean_welfare_base))/abs(mean_welfare_base))

welf_cost_flu_noamb = (mean_welfare_base - steady_state_welfare_base)/abs(steady_state_welfare_base)
welf_cost_flu_amb = (mean_welfare - steady_state_welfare)/abs(steady_state_welfare)
welf_cost_flu_amb_adj = (mean_welfare_adj - steady_state_welfare_base)/abs(steady_state_welfare_base)
...
vec_ss = [ss_noamb(strmatch('yd',M_.endo_names,'exact')) ss_noamb(strmatch('yg',M_.endo_names,'exact')) ...
          ...
          ss_noamb(strmatch('diffz',M_.endo_names,'exact'))];
...
if i == 16 | i == 17 | i == 18 | i == 23 | i == 25 | i == 28 | i == 29 | i == 30 | i == 31 | i == 32 | i == 33 | i == 34 | i == 35 | i == 40 | i == 41 | i == 42
...
for i = 1:size(mat_sh_amb2,2)
IRFs_sh_amb_w_mg6(:,i)=(mat_sh_amb2(:,i)/vec_ss(i))*100;
if i == 16 | i == 17 | i == 18 | i == 23 | i == 25 | i == 28 | i == 29 | i == 30 | i == 31 | i == 32 | i == 33 | i == 34 | i == 35 | i == 40 | i == 41 | i == 42
IRFs_sh_amb_w_mg6(:,i)=(mat_sh_amb2(:,i))*100;
end
end

save('amb_w_mg6_dyn_fin_results', 'IRFs_sh_amb_w_mg6')
*/
...
for i = 1:size(mat_sh_amb2,2)
IRFs_sh_amb_mg6(:,i)=(mat_sh_amb2(:,i)/vec_ss(i))*100;
if i == 16 | i == 17 | i == 18 | i == 23 | i == 25 | i == 28 | i == 29 | i == 30 | i == 31 | i == 32 | i == 33 | i == 34 | i == 35 | i == 40 | i == 41 | i == 42
IRFs_sh_amb_mg6(:,i)=(mat_sh_amb2(:,i))*100;
end
end

save('amb_mg6_dyn_fin_results', 'IRFs_sh_amb_mg6')
*/



/*
IRFs_sh_amb_w_kappa2=[];

for i = 1:size(mat_sh_amb2,2)
IRFs_sh_amb_w_kappa2(:,i)=(mat_sh_amb2(:,i)/vec_ss(i))*100;
if i == 16 | i == 17 | i == 18 | i == 23 | i == 25 | i == 28 | i == 29 | i == 30 | i == 31 | i == 32 | i == 33 | i == 34 | i == 35 | i == 40 | i == 41 | i == 42
IRFs_sh_amb_w_kappa2(:,i)=(mat_sh_amb2(:,i))*100;
end
end

save('amb_w_kappa2_dyn_fin_results', 'IRFs_sh_amb_w_kappa2')
*/
...
for i = 1:size(mat_sh_amb2,2)
IRFs_sh_amb_kappa2(:,i)=(mat_sh_amb2(:,i)/vec_ss(i))*100;
if i == 16 | i == 17 | i == 18 | i == 23 | i == 25 | i == 28 | i == 29 | i == 30 | i == 31 | i == 32 | i == 33 | i == 34 | i == 35 | i == 40 | i == 41 | i == 42
IRFs_sh_amb_kappa2(:,i)=(mat_sh_amb2(:,i))*100;
end
end

save('amb_kappa2_dyn_fin_results', 'IRFs_sh_amb_kappa2')
*/
